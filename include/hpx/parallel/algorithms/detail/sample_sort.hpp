...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_SORT_GENERAL_ALGORITHM_SAMPLE_SORT_HPP
#define __HPX_SORT_GENERAL_ALGORITHM_SAMPLE_SORT_HPP
...
#include <hpx/parallel/algorithms/detail/smart_merge_sort.hpp>
