...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_SORT_PARALLEL_ALGORITHM_INTRO_SORT_HPP
#define __HPX_SORT_PARALLEL_ALGORITHM_INTRO_SORT_HPP

#include <boost/sort/parallel/util/algorithm.hpp>
#include <hpx/parallel/algorithms/detail/insertion_sort.hpp>
#include <hpx/parallel/algorithms/detail/heap_sort.hpp>
