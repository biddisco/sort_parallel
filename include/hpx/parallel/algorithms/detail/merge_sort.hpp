...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_SORT_GENERAL_ALGORITHM_MERGE_SORT_HPP
#define __HPX_SORT_GENERAL_ALGORITHM_MERGE_SORT_HPP
...
#include <boost/sort/parallel/algorithms/insertion_sort.hpp>
#include <boost/sort/parallel/algorithms/token.hpp>
#include <boost/sort/parallel/algorithms/indirect.hpp>
...
namespace detail
{
using namespace hpx::sort::parallel::util ;
