...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_SORT_GENERAL_SORT_HPP
#define __HPX_SORT_GENERAL_SORT_HPP

#include <hpx/parallel/algorithms/detail/parallel_sort.hpp>
...
//****************************************************************************
namespace bs_algo = hpx::parallel::sort::detail ;
...
{   //---------------------------- begin -------------------------------------
    bs_algo::parallel_sort ( first, last);
};
//
//-----------------------------------------------------------------------------
//  function : paralle_introsort
...
{   //---------------------------- begin -------------------------------------
    bs_algo::parallel_sort ( first, last, comp);
};
//
//-----------------------------------------------------------------------------
